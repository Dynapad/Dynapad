...
#define DEFAULT_PROXY_HOST "surf.cs.unm.edu"
#define DEFAULT_SERVER_URL_DIR "http://www.cs.unm.edu/~jon"
#define DEFAULT_SERVER_DISK_DIR "/nfs/research/jon/public_html"
