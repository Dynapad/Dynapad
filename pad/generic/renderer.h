...
class Pad_Renderer
{
  public:
    ...
    virtual char *      Get_cap_style_name(void) = 0;
    ...
    virtual char *      Get_join_style_name(void) = 0;
...
class Pad_XRenderer : public Pad_Renderer
{
  public:
    ...
    virtual char *      Get_cap_style_name(void);
    ...
    virtual char *      Get_join_style_name(void);
