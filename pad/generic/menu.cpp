...
//
void
Pad_MenuItem::_Initialize_events(Pad_Win *win, const char *type) {
...
//
void
Pad_CheckboxMenuItem::_Initialize_events(Pad_Win *win, const char *type) {
    Pad_Callback *callback;
...
void
Pad_Menu::_Initialize_events(Pad_Win *win, const char *type) {
    Pad_Callback *callback;
...
void
Pad_ChoiceMenu::_Initialize_events(Pad_Win *win, const char *type) {
    Pad_Callback *callback;
