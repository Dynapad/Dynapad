...
#ifdef HAS_SCHEME
#  include "../generic/pad-scheme.h"
#endif

#ifdef HAS_SOUND
#  include "../generic/pad-sound.h"
#endif /* HAS_SOUND */
 ...
 *
 * Results:
 *	None: Pad_Main never returns here, so this procedure never
 *	returns either.
 *
 * Side effects:
...
Pad_Main(int argc, char **argv, Tcl_AppInitProc *appInitProc)
{
    ...
    Tcl_SetVar(interp, "tcl_interactive",
	    (char *)(((fileName == NULL) && tty) ? "1" : "0"), TCL_GLOBAL_ONLY);
